      ...
      <div className="Navigation">
        ...
        <NavLink to="/Tools">
          <div className="Nav-Obj" id="Tools">
            ...
            <span className="Nav-Obj-text">Apps</span>
          </div>
        </NavLink>

        <NavLink to="/Estore">
          <div className="Nav-Obj" id="Settings">
            <FontAwesome className='font-awesome' name='shopping-cart' style={{ textShadow: '0 1px 0 rgba(0, 0, 0, 0.1)', position: 'relative' }} />
            <span className="Nav-Obj-text">Estore</span>
          </div>
        </NavLink>
